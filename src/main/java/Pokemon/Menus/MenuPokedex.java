...
// Crear una tabla con las columnas correspondientes
            ...
            columnaVitalidad.setCellValueFactory(cellData -> new SimpleDoubleProperty(cellData.getValue().getVitalidad()));
            TableColumn<Pokemon, Number> columnaVelocidad = new TableColumn<>("Velocidad");
            columnaVelocidad.setCellValueFactory(cellData -> new SimpleDoubleProperty(cellData.getValue().getVelocidad()));
            TableColumn<Pokemon, Number> columnaEstamina = new TableColumn<>("Estamina");
            columnaEstamina.setCellValueFactory(cellData -> new SimpleDoubleProperty(cellData.getValue().getEstamina()));
            TableColumn<Pokemon, Number> columnaAtaque = new TableColumn<>("Ataque");
            columnaAtaque.setCellValueFactory(cellData -> new SimpleDoubleProperty(cellData.getValue().getAtaque()));
            TableColumn<Pokemon, Number> columnaDefensa = new TableColumn<>("Defensa");
            columnaDefensa.setCellValueFactory(cellData -> new SimpleDoubleProperty(cellData.getValue().getDefensa()));
            TableColumn<Pokemon, Number> columnaAtqEspecial = new TableColumn<>("Ataque Especial");
            columnaAtqEspecial.setCellValueFactory(cellData -> new SimpleDoubleProperty(cellData.getValue().getAtaqueEspecial()));
            TableColumn<Pokemon, Number> columnaDefEspecial = new TableColumn<>("Defensa Especial");
            columnaDefEspecial.setCellValueFactory(cellData -> new SimpleDoubleProperty(cellData.getValue().getDefensaEspecial()));
